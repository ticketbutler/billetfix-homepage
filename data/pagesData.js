    ...
    sections: [
...

      {
        ...
        images: [
          ...
          {
            src: '../img/ticketbutler.png',
            href: 'https://ticketbutler.io/da/',
          },
          {
            src: '../img/tiny-rhino.png',
        ...
        features: [
          {
            ...
            text_da:
              'Indtast <strong>navnet på dit arrangement, dato, antal deltagere du maksimalt kan have og prisen per deltager</strong> og begynd at modtage penge fra deltagere med det samme gennem et unikt link. Hvis du vil have flere typer deltagere med forskellige priser, kan du også tilføje det.',
          },
          ...
          },
          {
            ...
            text_da:
              'Til arrangementet har du nu en liste med alle deltagere, som du kan <strong>checke ind på en computer, tablet eller smartphone.</strong> Deltagerne har modtaget en billet på mail, som de har printet eller viser fra deres smartphone. Efter arrangementet modtager du automatisk en <strong>oversigt over det samlede billetsalg</strong> og pengene samlet på en ønsket konto.',
          },
        ],
      },
      {
        type: 'picture_left',
        heading_en: 'Guests can pay with MobilePay or their credit card',
        heading_da: 'Gæster kan betale med MobilePay eller kredit kort',

        strong_text_en: '50% of our users pay with MobilePay.',
        strong_text_da: '50% af vores brugere betaler med MobilePay.',
        text_en:
          'After the event has competed, your money is deposited directly into your bank account.',
        text_da:
          'Efter arrangementet er afsluttet, bliver dine penge overført direkte til din bankkonto.',
      },

      {
        type: 'mockup_right_first',
        heading_en: 'Sell tickets from your own website',
        heading_da: 'Sælg billetter direkte fra din egen hjemmeside',

        strong_text_en: 'Attendees can signup from your own website',
        strong_text_da: 'Deltagere kan tilmelde sig fra din egen hjemmeside',
        text_en:
          "It's as easy as copy & paste to start selling tickets on your own website - and it's free!",
        text_da:
          'Integrér billetsalget på din egen hjemmeside, ligeså nemt som at kopiere og indsætte en tekst – og desuden er det gratis!',
        button_text_en: 'view the live demo example',
        button_text_da: 'se live demo eksempel',
      },
      {
        type: 'mockup_right_second',
        heading_en: 'A unique event link, so you can share it anywhere',
        heading_da: 'Unikt link, du kan dele overalt',
        copyBoxLink: 'billetfix.dk/da/mad-hatters-cocktail-party/',
        strong_text:
      ...
      {
        type: 'pricing_cards',
        heading_en: 'The cheapest signup system in the market!',
        heading_da: 'Det billigste tilmeldingssystem på markedet!',
        ticketHeading_en: 'Attendee price',
        ticketHeading_da: 'Deltagerpris',
        ticketText1_en: '<strong>Free</strong> to host',
        ticketText1_da: '<strong>Gratis</strong> at være vært',
        ticketText2_en: '<strong>Free</Strong> website integration',
        ticketText2_da: '<strong>Gratis</Strong> hjemmeside integration',
        ticketText3_en: '<strong>Free</strong>support',
        ticketText3_da: '<strong>Gratis</strong>kundeservice',
        serviceFee_en: 'Service fee per attendee',
        serviceFee_da: 'Servicegebyr per deltager',
      ...
      {
        type: 'app',
        heading_en: 'Download your new best friend',
        heading_da: 'Download din nye bedste ven',
        text_en:
          'Follow the ticket sales and scan tickets at the event through the BilletFix app.',
        text_da:
          "Følg med i billetsalget og scan dine gæsters billetter til arrangementet med BilletFix app'en.",
      },
      {
        type: 'languages',
        heading_en: 'Language support',
        heading_da: 'Sprog valg',
        strong_text_en: 'Everything is in both English and Danish.',
        strong_text_da: 'Tilmelding og systemet er på både engelsk og dansk.',
      },
      {
        type: 'contact',
        heading_en: 'Contact',
        ...
        formHeadingName_en: 'Your name',
        formHeadingName_da: 'Dit navn',
        formHeadingEmail_en: 'Your email please',
        formHeadingEmail_da: 'Din Email tak',
        formHeadingMessage_en: 'Message',
        formHeadingMessage_da: 'Besked',
        headingAddress_en: 'Address',
        headingAddress_da: 'Adresse',
        textAddressStreet: 'Esplanaden 7,',
        ...
        sentMessage_en:
          'Thanks for your inquery! We will get back to you within 2 working days.',
        sentMessageSpam_en: 'For urgent matters please call 89 80 12 80',
        sentMessage_da: 'Tak, vi vender tilbage inden 2 arbejds dage!',
        sentMessageSpan_da: 'For akutte tilfælde, kontakt telefon: 89 80 12 80',
      },
    ],
  },
  {
        ...
        faqs: [
          {
            ...
            question_da:
              'Hvordan kan BilletFix have så lave servicegebyr i forhold til andre udbydere/billetsystemer?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'BilletFix er lavet til studerende på SU, så vi har presset prisen så langt ned, vi kan. Så langt ned at servicegebyret per billet svarer til flaskepant! Dette kan vi gøre, da vi i fremtiden vil vise reklamer for de tilmeldte.',
          },
          {
            id: 2,
            question_en: 'How do I integrate the signup on my own website?',
            question_da:
              'Hvordan integrerer jeg tilmeldingen på min hjemmeside?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'Du skal blot skrive til info@billetfix.dk, at du gerne vil have integreret din tilmelding på din hjemmeside, så sender vi dig en HTML-kode med det samme, som du blot skal kopiere ind på din hjemmeside.',
          },
          {
            id: 3,
            question_en: 'How do I link the signup to my Facebook event?',
            question_da:
              'Hvordan linker jeg min tilmelding til en Facebook begivenhed?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'For at linke din tilmelding til en Facebook begivenhed, skal begivenheden være oprettet fra enten en Facebook side eller Facebook gruppe. Når du opretter begivenheden, skal du blot kopiere dit unikke tilmeldingslink ind i feltet for ‘Webadresse til billetter’. Hvis begivenheden allerede er oprettet, skal du fra begivenhedens side trykke på ‘Rediger’, hvor du finder feltet ‘Webadresse til billetter’. Skriv endelig til info@billetfix.dk hvis du vil have hjælp til dette. Hvis du ikke har oprettet din Facebook begivenhed fra en side eller gruppe, kan du bare kopiere linket ind i begivenhedsbeskrivelsen.',
          },
          {
            id: 4,
            question_en: 'How do I cancel an event?',
            question_da: 'Hvordan aflyser jeg et arrangement?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'Først og fremmest skal du oplyse om arrangementets aflysning de steder, du fortæller folk om arrangementet (Facebook, mail, hjemmeside etc). Derefter skriver du en mail til info@billetfix.dk med arrangementets ID (starter med “#” og står nederst i boxen for det pågældende arrangement på din personlige oversigt) og skriver, at du gerne vil aflyse arrangementet, hvorefter vi klarer alt det tekniske.',
          },
          {
            id: 5,
            question_en:
            ...
            question_da:
              'Hvordan beder jeg om ekstra informationer om mine tilmeldte?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'Skriv en mail til info@billetfix.dk med arrangementets ID (starter med “#” og står nederst i boxen for det pågældende arrangement på din personlige oversigt) og derudover, hvad du gerne vil vide om gæsten. Så sørger vi for, at alle fremtidige tilmeldinger til pågældende arrangement bliver spurgt om den adspurgte information.',
          },
          {
            id: 6,
            question_en: "How do I scan the guest's tickets?",
            quesrtion_da: 'Hvordan scanner jeg mine gæsters tilmeldinger?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'BilletFix tilbyder et simpelt live check-ind, som du finder fra din personlige oversigt for det pågældende arrangement. Gæsten viser sin tilmelding fra sin smartphone eller fra den udprintede tilmelding, hvorefter man kan søge på gæstens navn og trykke “Check in”. Altså skal man hverken installere noget på sin computer eller hente en app – mere simpelt bliver det ikke!',
          },
          {
            id: 7,
            question_en:
            ...
            question_da:
              'Hvis jeg opretter et arrangement på den danske side, kan den så også vises på engelsk?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'Ja, man kan altid ændre sproget på siden ved at trykke på flaget oppe i højre hjørne uanset hvilket sprog, arrangementet er oprettet på.',
          },
          {
            id: 8,
            question_en: "I'm not a student, can I use BilletFix anyway?",
            question_da:
              'Jeg er ikke studerende – kan jeg bruge BilletFix alligevel?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'Systemet kan faktisk bruges til alle typer af events. Skriv endelig til info@billetfix.dk hvis du mangler nogle bestemte funktioner til dit arrangement.',
          },
          {
            id: 9,
            question_en: 'How much does it cost to use BilletFix?',
          ...
          {
            id: 10,
            question_en: 'When do I receive the money collected for an event?',
            question_da: 'Hvornår modtager jeg pengene for et arrangement?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'For at sikre gæsternes ret til refundering af prisen for tilmeldingen, hvis arrangementet ikke bliver afholdt, bestræber vi os på at overføre pengene til arrangøren inden for tre arbejdsdage efter afholdt arrangement.',
          },
          {
            id: 11,
            question_en: 'Can I provide a description of an event?',
            question_da:
              'Kan jeg ikke indtaste en beskrivelse af arrangementet?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'BilletFix’ koncept er simplicitet, så du ikke også skal indtaste alle informationer på BilletFix’ hjemmeside, når du alligevel giver alle detaljerne på Facebook, på din hjemmeside eller i en mail. Skriv til info@billetfix.dk hvis du ønsker at indsætte en beskrivelse på din unikke tilmeldingsside.',
          },
          {
            id: 12,
            question_en: 'Can I limit the amount of tickets someone can buy?',
            question_da:
              'Kan jeg begrænse, hvor mange tilmeldinger en gæst kan lave af gangen?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'Ja, skriv blot en mail til info@billetfix.dk med arrangementets ID (starter med “#” og står nederst i boxen for det pågældende arrangement på din personlige oversigt) og hvad begrænsningen skal være, så sørger vi for resten.',
          },
          {
            id: 13,
            question_en:
            ...
            question_da:
              'Kan jeg sende en besked til alle mine gæster inden arrangementet?',
            type: 'organiser',
            answer_en:
            ...
            answer_da:
              'Ja, skriv blot en mail til info@billetfix.dk med arrangementets ID (starter med “#” og står nederst i boxen for det pågældende arrangement på din personlige oversigt) og hvad beskeden skal være, så sørger vi for, at beskeden bliver sendt ud.',
          },
          {
            id: 14,
            question_en: 'Do you have an API?',
            question_da: 'Har I et API?',
            type: 'organiser',
            answer_en:
              'Yes, we have an API in private Beta. Just write an email to info@billetfix.dk if you’re interested in getting access.',
            answer_da:
              'Ja, vi har et API, men ikke offentlig tilgængeligt. Skriv en mail til info@billetfix.dk, hvis du er interesseret i en API-løsning.',
          },
          {
            id: 15,
            question_en: "I haven't received my ticket what do I do?",
            question_da:
              ' Jeg har ikke modtaget min tilmelding – hvad gør jeg?',
            type: 'guest',
            answer_en:
              'Write a message or call the organizer of the event. The contact information is on the event page where you’ve signed up.',
            answer_da:
              'Skriv eller ring til arrangøren af arrangementet. Kontaktoplysninger finder du siden, hvor du har tilmeldt dig.',
          },
          {
            id: 16,
            question_en: 'How do I find the address of the event?',
            question_da: ' Hvor finder jeg adressen på arrangementet?',
            type: 'guest',
            answer_en:
              'The address is where you found the description about the event. e.g. on Facebook, website or newsletter.',
            answer_da:
              'Adressen på arrangementet finder du på siden, hvor arrangøren har placeret sin beskrivelse af arrangement (Facebook, mail eller hjemmeside).',
          },
          {
            id: 17,
            question_en: 'The event has been cancelled, what do I do?',
            type: 'guest',
            question_da:
              'Arrangementet, jeg tilmeldt mig til, er blevet aflyst – hvad gør jeg?',
            answer_en:
            ...
            answer_da:
              'Hvis du ikke har modtaget dine penge inden for et par dage efter arrangøren har meldt arrangement aflyst, så skriv en mail til info@billetfix.dk med arrangementets navn og evt link til tilmelding.',
          },
          {
            id: 18,
            question_en: 'Do I need to print out the ticket?',
            question_da: 'Skal jeg printe min tilmelding ud?',
            type: 'guest',
            answer_en:
              'No, you don’t have to print it out unless the organizer has told you so. Just show the ticket on your smartphone.',
            answer_da:
              'Nej, det er ikke en nødvendighed, medmindre arrangøren har oplyst herom. Som udgangspunkt skal du bare vise billetten fra dire.,n smartphone.',
          },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        sentMessage1_en:
          'Thanks for your inquery! We will get back to you within 2 working days.',
        sentMessage2_en: 'For urgent matters please call 89 80 12 80',
        sentMessage1_da: 'Tak, vi vender tilbage inden 2 arbejds dage!',
        sentMessage2_da: 'For akutte tilfælde, kontakt telefon: 89 80 12 80',
      },
    ],
  },
]
